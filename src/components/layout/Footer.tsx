...
const socials = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/rafael-aceituno-%C3%A1lvarez-99a05a292?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    svg: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
