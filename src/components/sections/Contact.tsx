            ...
            <div className="relative z-10 p-6 sm:p-10">
              ...
              >
                {[
                  ...
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill={link.href.includes("github") ? "currentColor" : "none"} stroke={link.href.includes("mailto") ? "currentColor" : undefined} strokeWidth={link.href.includes("mailto") ? 1.5 : undefined}>
                      {link.icon}
                    </svg>
                  </motion.a>
                ))}
